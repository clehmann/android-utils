...
public class TableTest {
    ...
    public void testGenerateSqlWithMultipleColumns() throws Exception {
        Table table = new Table("TEST", null).addColumn(new IntegerColumn("COL")).addColumn(new Column("COL2", Column.Type.STRING));
