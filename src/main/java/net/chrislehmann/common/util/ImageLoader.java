...
/**
 * Singleton that can load {@link android.widget.ImageView}s with data from a Url and cache them.  The {@link ImageLoader}
...
public enum ImageLoader {
    ...
    private ImageLoader() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            _cache = new FileImageCache(Environment.getExternalStorageDirectory().getAbsolutePath() + "/data/net.chrislehmann.squeezedroid");
    ...
    /**
     * Load an image at url into the {@link android.widget.ImageView} image.  if the image is already in the cache, it will be loaded
    ...
    /**
     * Clear out the queue of items to be downloaded and stops all of the download threads.  Any calls to {@link ImageLoader#load(android.widget.ImageView, String)}
    ...
    /**
     * Class that contains information about an image to be downloaded and the {@link android.widget.ImageView} it will
     * be loaded into
     */
